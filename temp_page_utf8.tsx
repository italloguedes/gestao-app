...
export default function GestaoPage() {
  ...
  const checkUser = async () => {
    try {
      ...
      if (user) {
        ...
        if (userError) {
          console.error('Erro ao verificar permiss├Áes:', userError);
          setIsAdmin(false);
          return;
        }
      ...
      console.error('Erro ao verificar usu├írio:', err);
      setIsAdmin(false);
    }
  };
  ...
  const cards: DashboardCard[] = [
    {
      title: 'Gest├úo de Vagas',
      description: 'Gerencie a disponibilidade de hor├írios e bloqueios',
    ...
    },
    {
      ...
      description: 'Link para consulta p├║blica de documentos por CPF',
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-2 text-gray-600">Voc├¬ n├úo tem permiss├úo para acessar esta p├ígina.</p>
        </div>
      </div>
    );
  }
    ...
    <>
      ...
      <div className="min-h-screen bg-gray-50 py-8 px-4 pt-20">
        <div className="max-w-7xl mx-auto">
          <div className="mb-8">
            <h1 className="text-3xl font-bold text-gray-900">Gest├úo do Sistema</h1>
            <p className="mt-2 text-gray-600">
              Bem-vindo ao painel de gest├úo. Selecione uma das op├º├Áes abaixo para come├ºar.
            </p>
          </div>
