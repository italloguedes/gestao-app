...
CREATE INDEX idx_observacoes_atendimento ON atendimento_observacoes_historico(atendimento_id);
CREATE INDEX idx_observacoes_created_at ON atendimento_observacoes_historico(created_at DESC);
