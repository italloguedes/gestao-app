                ...
                return (
                  <div
                    ...
                    className={`relative group rounded-3xl transition-all duration-300 min-h-[260px] flex flex-col ${agendamentosHorario.length > 0
                      ? hasBeingAttended
                        ? "bg-gradient-to-br from-indigo-50/90 via-purple-50/90 to-blue-50/90 border-2 border-indigo-400 ring-4 ring-indigo-200/50 shadow-xl shadow-indigo-100/50"
                        : hasPreferential
                  ...
                  >
                    <div className="p-6 flex flex-col h-full">
                      ...
                      <div className="flex items-center justify-between mb-5">
                        <div
                          className={`flex items-center rounded-2xl px-4 py-2 text-sm font-bold shadow-sm transition-all duration-300 ${hasBeingAttended
                          ...
                          <div className="flex items-center gap-2">
                            {agendamentosHorario.map((agendamento) => {
                              ...
                              const statusColor = inAtt
                                ? "bg-indigo-600 ring-indigo-300 animate-pulse"
                                : ({
                                  ...
                                  <div className="pt-2 flex flex-col gap-2">
                                    ...
                                    {agendamento.status === "confirmado" && !isRecepcao && (
                                      <button
                                        ...
                                        className={`w-full px-4 py-2.5 text-sm rounded-xl text-white shadow-lg transition-all duration-300 flex items-center justify-center font-bold transform hover:-translate-y-0.5 ${
                                          inAttendance
                                            ? "bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 shadow-indigo-200/50"
                                            : "bg-gradient-to-r from-emerald-500 to-green-600 hover:from-emerald-600 hover:to-green-700 shadow-emerald-200/50"
                                        }`}
                                      >
