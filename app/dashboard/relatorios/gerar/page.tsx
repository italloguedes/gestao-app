...
const statusOptions = [
  ...
  { value: 'pendente', label: 'Pendente', count: 0 },
            ...
            <div className="px-6 py-4">
              ...
              <div className="flex flex-wrap gap-2">
                ...
                <button
                  ...
                  className={`px-4 py-2 rounded-full text-sm font-medium border transition-colors ${status === 'pendente'
                    ...
                    .map((atendimento) => (
                      <tr key={atendimento.id} className="hover:bg-gray-50">
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          <span className={`px-3 py-1 inline-flex text-xs leading-5 font-medium rounded-full ${atendimento.status === 'pendente' ? 'bg-blue-100 text-blue-800' :
